...
class TestButton(unittest.TestCase):
    ...
    def test_draw_normal_state(self, mock_draw_rect, mock_get_pos):
        ...
        self.mock_font.render.assert_called_with("Click Me", True, self.button.text_color)
        ...
        self.mock_surface.blit.assert_called_once_with(self.mock_text_surface, text_rect)
    ...
    def test_handle_event_click_inside(self):
        ...
        click_event = create_mock_event(pygame.MOUSEBUTTONDOWN, pos=(150, 125), button=1)
    ...
    def test_handle_event_wrong_mouse_button(self):
        ...
        right_click_event = create_mock_event(pygame.MOUSEBUTTONDOWN, pos=(150, 125), button=3)
