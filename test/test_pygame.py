...
class TestButtonHandling(unittest.TestCase):
    ...
    def test_button_click_detection(self):
        ...
        click_event = pygame.event.Event(
            pygame.MOUSEBUTTONDOWN, {"pos": (75, 675), "button": 1}
        )
...
class TestGameStateManagement(unittest.TestCase):
    ...
    def test_board_click_before_roll(self):
        ...
        if result and result["type"] == "point_click":
            self.assertFalse(dice_rolled, "Should not process moves before dice roll")
    ...
    def test_turn_state_reset(self):
        ...
        self.assertEqual(
            len(self.board.dice_values), 0, "Dice values should reset on turn switch"
        )
...
class TestKeyboardControls(unittest.TestCase):
    ...
    def test_space_key_roll(self):
        ...
        self.assertNotEqual(
            initial_dice, self.board.dice_values, "Dice values should change after roll"
        )
    ...
    def test_r_key_reset(self):
        ...
        self.assertEqual(len(self.board.dice_values), 0, "Dice values should reset")
